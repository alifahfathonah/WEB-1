		...
		<div class="main">
			<div class="wrap">
				<div class="content">
					...
					<?php  
						   $section =0;
						   $sql = $objek->query("select * from buku");
						   $i = 1;
					...
					?>
							   	...
							   	<div class="grid_1_of_5 images_1_of_5">
									<a href="preview.php"><img src="images/Sirah.jpg" alt="" /></a>
									<h2><a href="preview.php"><?php echo $data['nama_buku'] ?></a></h2>
										<div class="price-details">
											<div class="price-number">
											<p><b><h1>Stock : </h1></b></h1>
											<span class="rupees"><?php echo $data['jumlah'] ?></span></p>
											</div>
											<div class="add-cart">								
		...
		<div class="footer">
			<div class="wrap">	
				...
				<div class="copy_right">
					<p>Perpustakaan Online © All rights Reseverd | Design by Riki Ahmad </p>
				</div>			
			</div>
		</div>
		<script type="text/javascript">
